...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1710265566995.2864";
}
function EventCard({
  event,
  className
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("article", { className: `post-card bg-white rounded-lg shadow-md p-5 mb-4 relative ${className}`, children: [
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "relative flex-grow", children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("img", { src: event.image, alt: event.title, className: "w-full h-48 object-cover rounded-md" }, void 0, false, {
        fileName: "app/components/EventCard.jsx",
        lineNumber: 34,
        columnNumber: 9
      }, this),
...
//# sourceMappingURL=/build/_shared/chunk-DCMRXS4K.js.map
